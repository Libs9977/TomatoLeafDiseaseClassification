...
train_batches = datagen.flow_from_directory(directory=train_path,  target_size=(224, 224), batch_size=bs, class_mode='categorical')
valid_batches = datagen.flow_from_directory(directory=valid_path, target_size=(224, 224), batch_size=bs, class_mode='categorical')
test_batches = datagen.flow_from_directory(directory=test_path, target_size=(224, 224), batch_size=bs, class_mode='categorical',shuffle=False)

model = Sequential([
    Conv2D(filters=64, kernel_size=(7, 7), strides=(2, 2), padding='same', activation='relu', input_shape=(224, 224, 3)),
